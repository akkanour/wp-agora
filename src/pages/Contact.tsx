        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2">
            ...
            <div className="mt-2.5 relative">
              <input id="phone-number" name="phone-number" type="tel" ref={phoneInputRef} className="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm" />
            </div>
          </div>
          ...
          <div className="flex gap-x-4 sm:col-span-2">
            ...
            <label htmlFor="consent" className="text-sm text-gray-600">
              ...
              <button type="button" onClick={openPrivacyModal} className="font-semibold text-indigo-600 underline">politique de confidentialité</button>.
            </label>
          </div>
        </div>
      ...
      {isPrivacyModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 z-50">
          ...
          <h1 className="text-3xl font-bold mb-4">Privacy Policy</h1>
            ...
            <p className="text-base mb-4">This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You.</p>
            <p className="text-base mb-4">We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy.</p>
            ...
            <p className="text-base mb-4">The words of which the initial letter is capitalized have meanings defined under the following conditions...</p>
            ...
            <ul>
              ...
              <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Agora Technology, 227, Boulevard GHANDI, N° 2, 20380-Casablanca.</p>
              </li>
              <li>
              ...
              <li>
                <p><strong>Website</strong> refers to Agora Technology, accessible from <a href="https://agora-technology.com" rel="external nofollow noopener" target="_blank">https://agora-technology.com</a></p>
              </li>
              <li>
            ...
            <ul>
              <li>By visiting this page on our website: <a href="https://agora-technology.com/contact" rel="external nofollow noopener" target="_blank">https://agora-technology.com/contact</a></li>
            </ul>
            <div className="mt-6 text-right">
              <button onClick={closePrivacyModal} className="bg-indigo-600 text-white px-4 py-2 rounded-md hover:bg-indigo-500">Fermer</button>
            </div>
          </div>
        </div>
      )}
